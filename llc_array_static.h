...
#pragma pack(pop)
	...
	tplN2uusng	astsc_t		= ::llc::astatic<sc_t, N>; tplN2uusng astc		= ::llc::astatic<sc_t, N>; tplN2uusng astaticc		= ::llc::astc	<N>; tplN2uusng astchar		= ::llc::astatic<sc_t, N>;
	tplN2uusng	astu0_t		= ::llc::astatic<u0_t, N>; tplN2uusng astu8 	= ::llc::astatic<u0_t, N>; tplN2uusng astaticu8 	= ::llc::astu8 	<N>;
	tplN2uusng	astu1_t		= ::llc::astatic<u1_t, N>; tplN2uusng astu16	= ::llc::astatic<u1_t, N>; tplN2uusng astaticu16	= ::llc::astu16	<N>;
	tplN2uusng	astu2_t		= ::llc::astatic<u2_t, N>; tplN2uusng astu32	= ::llc::astatic<u2_t, N>; tplN2uusng astaticu32	= ::llc::astu32	<N>;
	tplN2uusng	astu3_t		= ::llc::astatic<u3_t, N>; tplN2uusng astu64	= ::llc::astatic<u3_t, N>; tplN2uusng astaticu64	= ::llc::astu64	<N>;
	tplN2uusng	asts0_t		= ::llc::astatic<s0_t, N>; tplN2uusng asti8 	= ::llc::astatic<s0_t, N>; tplN2uusng astatici8 	= ::llc::asti8 	<N>;
	tplN2uusng	asts1_t		= ::llc::astatic<s1_t, N>; tplN2uusng asti16	= ::llc::astatic<s1_t, N>; tplN2uusng astatici16	= ::llc::asti16	<N>;
	tplN2uusng	asts2_t		= ::llc::astatic<s2_t, N>; tplN2uusng asti32	= ::llc::astatic<s2_t, N>; tplN2uusng astatici32	= ::llc::asti32	<N>;
	tplN2uusng	asts3_t		= ::llc::astatic<s3_t, N>; tplN2uusng asti64	= ::llc::astatic<s3_t, N>; tplN2uusng astatici64	= ::llc::asti64	<N>;
	tplN2uusng	astf2_t		= ::llc::astatic<f2_t, N>; tplN2uusng astf32	= ::llc::astatic<f2_t, N>; tplN2uusng astaticf32	= ::llc::astf32	<N>;
	tplN2uusng	astf3_t		= ::llc::astatic<f3_t, N>; tplN2uusng astf64	= ::llc::astatic<f3_t, N>; tplN2uusng astaticf64	= ::llc::astf64	<N>;
