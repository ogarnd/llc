...
namespace llc
{
	...
	stin	llc::err_t	appendKeyString	(::llc::asc_t & output, ::llc::vcs key, ::llc::vcsc_c & value	, bool prependComma = false)	{ return appendKeyString(output, key, ::llc::vcs{value}, prependComma); }
