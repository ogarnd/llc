...
namespace llc
{
	...
	tplt <tpnm TEnum>	const ::llc::vcc&				get_value_descp		(const TEnum & statusBit)				{ return ::llc::get_enum<TEnum>().get_value_desc (statusBit); }
...
#define llc_warning_unhandled_value(valueUnhandled)		warning_printf("Unhandled %s value: (0x%X)(%X)(%c) %s", ::llc::get_enum_namep(valueUnhandled), valueUnhandled, valueUnhandled, (char)valueUnhandled, ::llc::get_value_namep(valueUnhandled))
#define llc_enum_value_info(_enumValue)					info_printf("'%s' value: (0x%X)(%X)(%c) '%s'", ::llc::get_enum_namep(_enumValue), _enumValue, _enumValue, (char)_enumValue, ::llc::get_value_namep(_enumValue))
