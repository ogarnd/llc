...
#pragma pack(pop)
	...
	ndstinx ::llc::packedu16	int_pack	(const uint16_t value) { return {tail_width(value), tail_multiplier(value), tail_base(value)}; } 
	ndstinx ::llc::packedu32	int_pack	(const uint32_t value) { return {tail_width(value), tail_multiplier(value), tail_base(value)}; } 
	ndstinx ::llc::packedu64	int_pack	(const uint64_t value) { return {tail_width(value), tail_multiplier(value), tail_base(value)}; } 
	ndstinx ::llc::packedi16	int_pack	(const int16_t  value) { return {tail_width(value), tail_multiplier(value), tail_base(value)}; } 
	ndstinx ::llc::packedi32	int_pack	(const int32_t  value) { return {tail_width(value), tail_multiplier(value), tail_base(value)}; } 
	ndstinx ::llc::packedi64	int_pack	(const int64_t  value) { return {tail_width(value), tail_multiplier(value), tail_base(value)}; } 
}
