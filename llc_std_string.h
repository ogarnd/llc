...
namespace llc
{
	...
	stainli	::llc::error_t	toachar (::llc::achar	& output, const std::string & srcstr)	{ llc_necs(output.reserve((uint32_t)srcstr.length())); return (output = ::llc::tovcc(srcstr)).size(); }
