#include "llc_log_level.h"

#ifndef LLC_LOG_H_23627
#define LLC_LOG_H_23627
...
#	define ree_if_failed(llcl_call, ...)		if_fail_vef(-1, (llcl_call), __VA_ARGS__)	
#	define rew_if_failed(llcl_call, ...)		if_fail_vef(-1, (llcl_call), __VA_ARGS__)	
#	define rei_if_failed(llcl_call, ...)		if_fail_vef(-1, (llcl_call), __VA_ARGS__)	
#	define rea_if_failed(llcl_call, ...)		if_fail_vef(-1, (llcl_call), __VA_ARGS__)	
#	define rees_if_failed(llcl_call)			if_fail_ve(-1, (llcl_call))
#	define rews_if_failed(llcl_call)			if_fail_ve(-1, (llcl_call))
#	define reis_if_failed(llcl_call)			if_fail_ve(-1, (llcl_call))
#	define reas_if_failed(llcl_call)			if_fail_ve(-1, (llcl_call))
#	define re_if_failed(condition, format, ...)	re_if (0 > llc::error_t(condition), format, __VA_ARGS__)
#	define rw_if_failed(condition, format, ...)	rw_if (0 > llc::error_t(condition), format, __VA_ARGS__)
#	define ri_if_failed(condition, format, ...)	ri_if (0 > llc::error_t(condition), format, __VA_ARGS__)
#	define ra_if_failed(condition, format, ...)	ra_if (0 > llc::error_t(condition), format, __VA_ARGS__)
#	define res_if_failed(condition)				res_if(0 > llc::error_t(condition))
#	define rws_if_failed(condition)				rws_if(0 > llc::error_t(condition))
#	define ris_if_failed(condition)				ris_if(0 > llc::error_t(condition))
#	define ras_if_failed(condition)				ras_if(0 > llc::error_t(condition))
