...
#pragma pack(pop)
	...
	ndstain	::llc::error_t	jsonObjectKeyCount	(const ::llc::SJSONReader & reader, uint32_t iNode)												{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonObjectKeyCount(*reader.Tree[iNode]); }
	ndstain	::llc::error_t	jsonArraySize		(const ::llc::SJSONReader & reader, uint32_t iNode)												{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonArraySize(*reader.Tree[iNode]); }
	ndstain	::llc::error_t	jsonArrayValueGet	(const ::llc::SJSONReader & reader, uint32_t iNode, uint32_t indexOfValueToGet)					{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonArrayValueGet(*reader.Tree[iNode], indexOfValueToGet); }
	ndstain	::llc::error_t	jsonObjectValueGet	(const ::llc::SJSONReader & reader, uint32_t iNode, const ::llc::vcs & key)						{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonObjectValueGet(*reader.Tree[iNode], reader.View, {key.begin(), key.size()}); }
	stainli	::llc::error_t	jsonObjectKeyList	(const ::llc::SJSONReader & reader, uint32_t iNode, ::llc::ai32 & indices)						{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonObjectKeyList(*reader.Tree[iNode], indices); }
	stainli	::llc::error_t	jsonObjectKeyList	(const ::llc::SJSONReader & reader, uint32_t iNode, ::llc::avcc & keys)							{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonObjectKeyList(*reader.Tree[iNode], reader.View, keys); }
	stainli	::llc::error_t	jsonObjectKeyList	(const ::llc::SJSONReader & reader, uint32_t iNode, ::llc::ai32 & indices, ::llc::avcc & keys)	{ rew_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); rees_if(!reader.Tree[iNode]); return jsonObjectKeyList(*reader.Tree[iNode], reader.View, indices, keys); }
