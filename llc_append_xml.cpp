...
llc::err_t	llc::appendXmlOpenTag		(::llc::asc_t & output, ::llc::vcs tagName) 							{ return llc::append_strings(output, '<', tagName); }
llc::err_t	llc::appendXmlTagClosing	(::llc::asc_t & output, ::llc::vcs tagName) 							{ return llc::append_strings(output, "</", tagName, '>'); }
llc::err_t	llc::appendXmlTagOpening	(::llc::asc_t & output, ::llc::vcs tagName, ::llc::vcs tagAttributes)	{
	return tagAttributes.size()
		? ::llc::append_strings(output, '<', tagName, ' ', tagAttributes, " >")
		: ::llc::append_strings(output, '<', tagName, '>')
		;
}
llc::err_t	llc::appendXmlTagVoid		(::llc::asc_t & output, ::llc::vcs tagName, ::llc::vcs tagAttributes) {
	return tagAttributes.size()
		? ::llc::append_strings(output, '<', tagName, ' ', tagAttributes, " >")
		: ::llc::append_strings(output, '<', tagName, " />")
		;
}
llc::err_t	llc::appendXmlTag			(::llc::asc_t & output, ::llc::vcs tagName, ::llc::vcs tagAttributes, ::llc::vcs innerHtml) {
	return tagAttributes.size()
		? ::llc::append_strings(output, '<', tagName, ' ', tagAttributes, " >", innerHtml, "</", tagName, '>')
		: ::llc::append_strings(output, '<', tagName, '>', innerHtml, "</", tagName, '>')
		;
}
llc::err_t	llc::appendXmlAttr			(::llc::asc_t & output, ::llc::vcs attrName, ::llc::vcs attrValue)	{
	return attrValue.size()
		? ::llc::append_strings(output, " ", attrName, "=\"", attrValue, '"')
		: ::llc::append_strings(output, " ", attrName)
		;
}
llc::err_t	llc::appendXmlTag			(::llc::asc_t & output, ::llc::vcs tagName, ::llc::vcs tagAttributes, const ::llc::FAppend & funcAppend) {
	int32_t			result						= 0;
...
llc::err_t	llc::appendXmlTag			(::llc::asc_t & output, ::llc::vcs tagName, ::llc::vcs tagAttributes, const ::llc::function<llc::err_t()> & funcAppend) {
	int32_t			result						= 0;
...
llc::err_t	llc::appendXmlTag			(::llc::asc_t & output, ::llc::vcs tagName, const ::llc::function<llc::err_t()> & funcAppendAttrs, const ::llc::function<llc::err_t()> & funcAppend) {
	int32_t			result						= 0;
	if(!funcAppendAttrs)
